...
["", "custom.dart", , N, {
  ...
  main: [function() {
    ...
    var t1 = document.querySelector("#compile");
    t1.toString;
    t1 = H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(t1, C.EventStreamProvider_click._eventType, false), [null]);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(N.unhide$closure()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
  }, "call$0", "main$closure", 0, 0, 0],
  unhide: [function($event) {
    document.querySelector("#output").hidden = false;
  }, "call$1", "unhide$closure", 2, 0, 1]
},
1],
...
//# sourceMappingURL=custom.dart.js.map
//@ sourceMappingURL=custom.dart.js.map
