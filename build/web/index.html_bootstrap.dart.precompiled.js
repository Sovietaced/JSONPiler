            ...
            if (t2.test(lexeme)) {
              ...
              if (t1.test(lexeme))
                ...
                if (t3.test(lexeme)) {
                  ...
                  else if (J.$eq(t7.get$length(lexeme), 1))
...
["SemanticAnalyzer", "compiler/semanticAnalyzer.dart", , A, {
  ...
  SemanticAnalyzer: {
    ...
    convertStatement$2: function(currNode, $parent) {
      var tree, t1, line, type, id, variableDeclaration, t2, value, assignmentStatement, idValue, expressionValues;
      tree = J.get$first$ax(J.get$children$x(currNode));
      t1 = J.getInterceptor$x(tree);
      line = H.S(t1.get$data(tree));
      H.printString(line);
      switch (t1.get$data(tree)) {
        case C.NonTerminal_VARIABLE_DECLARATION:
        ...
        case C.NonTerminal_ASSIGNMENT_STATEMENT:
    ...
    convertStringExpression$2: function(currNode, $parent) {
      ...
      for (t1 = J.get$iterator$ax(J.get$children$x(currNode)); t1.moveNext$0();) {
        ...
        if (J.$eq(t2.get$data(tree), C.NonTerminal_CHAR_LIST)) {
          t2 = A.SemanticAnalyzer_convertCharList(tree, stringTree);
          C.JSArray_methods.addAll$1(stringTree.children, t2);
        }
      }
      return stringTree;
    },
    static: {"^": "SemanticAnalyzer_log", SemanticAnalyzer_convertCharList: function(currNode, $parent) {
        var subTrees, t1, tree, t2, t3;
        subTrees = [];
        subTrees.$builtinTypeInfo = [B.Tree];
        for (t1 = J.get$iterator$ax(J.get$children$x(currNode)); t1.moveNext$0();) {
...
["_interceptors", "dart:_interceptors", , J, {
  ...
  Interceptor: {
    ...
    "%": "ArrayBuffer|MediaError|MediaKeyError|Navigator|PositionError|SQLError|SVGAnimatedEnumeration|SVGAnimatedNumberList|SVGAnimatedString"
  },
  JSBool: {
    "^": "bool/Interceptor;",
    toString$0: function(receiver) {
...
["app_bootstrap", "index.html_bootstrap.dart", , E, {
  "^": "",
  main0: [function() {
    $._librariesToLoad = ["main.dart"];
    $._useDirtyChecking = false;
    F.main();
  }, "call$0", "main0$closure", 0, 0, 2]
},
1],
["", "compiler/compiler.dart", , X, {
  "^": "",
  Compiler: {
    "^": "Object;log,source,tokens,symbols,cst,ast,parser,analyzer",
    run$0: function() {
      var hash, t1, exception;
      try {
...
["dart._internal", "dart:_internal", , H, {
  ...
  Symbol_getName: function(symbol) {
    return symbol.get$_name(symbol);
  },
  ListIterator: {
...
["", "main.dart", , F, {
  ...
  compile: [function($event) {
    ...
    new X.Compiler(K.LoggerUtil_createLogger("Compiler"), source, H.setRuntimeTypeInfo([], [D.Token]), null, null, null, null, null).run$0();
  ...
  Parser: {
    ...
    analyse$0: function() {
      ...
      if (this.tokens.length !== 0) {
        ...
        if (!J.$eq(t1.get$type(token), C.TokenType_END))
          M.ExceptionUtil_logAndThrow(new T.CompilerSyntaxError(C.JSString_methods.$add("Expected END token, found type ", J.get$value$x(t1.get$type(token))) + " on line " + C.JSInt_methods.toString$0(token.get$line())), $.get$Parser_log());
    ...
    block$1: function(currNode) {
      var child, t1, child0;
      $.get$Parser_log().log$4(C.Level_INFO_800, "Parsing block on line " + C.JSInt_methods.toString$0(this.getToken$0().get$line()), null, null);
    ...
    statementList$1: function(currNode) {
      ...
      token = this.popNextToken$0();
      for (; t1 = J.getInterceptor$x(token), !J.$eq(t1.get$type(token), C.TokenType_CLOSE_BRACE); currNode = child) {
        child = new B.Tree(C.NonTerminal_STATEMENT_LIST, currNode, null);
        t2 = [];
        t2.$builtinTypeInfo = [B.Tree];
        child.children = t2;
        currNode.children.push(child);
        if (J.$eq(t1.get$type(token), C.TokenType_TYPE)) {
          child0 = new B.Tree(C.NonTerminal_STATEMENT, child, null);
          t1 = [];
          t1.$builtinTypeInfo = [B.Tree];
          child0.children = t1;
          child.children.push(child0);
          $.get$Parser_log().log$4(C.Level_INFO_800, "Parsing a variable declaration on line " + C.JSInt_methods.toString$0(this.getToken$0().get$line()), null, null);
          ...
          t1 = J.getInterceptor$x(typeToken);
          child0 = new B.Tree(t1.get$type(typeToken), child1, null);
          t2 = [];
          t2.$builtinTypeInfo = [B.Tree];
          child0.children = t2;
          child1.children.push(child0);
          child2 = new B.Tree(t1.get$value(typeToken), child0, null);
          t2 = [];
          t2.$builtinTypeInfo = [B.Tree];
          child2.children = t2;
          ...
          t2 = J.get$value$x(token);
          t3 = this.scope;
          t4 = token.get$line();
          t1 = t1.get$value(typeToken);
        ...
        } else if (J.$eq(t1.get$type(token), C.TokenType_ID)) {
          child0 = new B.Tree(C.NonTerminal_STATEMENT, child, null);
          t1 = [];
          t1.$builtinTypeInfo = [B.Tree];
          child0.children = t1;
          child.children.push(child0);
          $.get$Parser_log().log$4(C.Level_INFO_800, "Parsing assignment statement on line " + C.JSInt_methods.toString$0(this.getToken$0().get$line()), null, null);
          ...
          this.scopeCheck$0();
        } else if (J.$eq(t1.get$type(token), C.TokenType_IF)) {
          child0 = new B.Tree(C.NonTerminal_STATEMENT, child, null);
          t1 = [];
          t1.$builtinTypeInfo = [B.Tree];
          child0.children = t1;
          child.children.push(child0);
          $.get$Parser_log().log$4(C.Level_INFO_800, "Parsing if statement on line " + C.JSInt_methods.toString$0(this.getToken$0().get$line()), null, null);
          ...
          this.index = this.index + 1;
          this.block$1(child1);
        } else if (J.$eq(t1.get$type(token), C.TokenType_WHILE)) {
          child0 = new B.Tree(C.NonTerminal_STATEMENT, child, null);
          t1 = [];
          t1.$builtinTypeInfo = [B.Tree];
          child0.children = t1;
          child.children.push(child0);
          $.get$Parser_log().log$4(C.Level_INFO_800, "Parsing while statement on line " + C.JSInt_methods.toString$0(this.getToken$0().get$line()), null, null);
          ...
          this.index = this.index + 1;
          this.block$1(child1);
        } else if (J.$eq(t1.get$type(token), C.TokenType_PRINT)) {
          child0 = new B.Tree(C.NonTerminal_STATEMENT, child, null);
          t1 = [];
          t1.$builtinTypeInfo = [B.Tree];
          child0.children = t1;
          child.children.push(child0);
          $.get$Parser_log().log$4(C.Level_INFO_800, "Parsing print statement on line " + C.JSInt_methods.toString$0(this.getToken$0().get$line()), null, null);
          ...
          child0.children = t1;
          child1.children.push(child0);
        } else if (J.$eq(t1.get$type(token), C.TokenType_OPEN_BRACE)) {
          child0 = new B.Tree(C.NonTerminal_STATEMENT, child, null);
          t1 = [];
          t1.$builtinTypeInfo = [B.Tree];
          child0.children = t1;
          ...
          M.ExceptionUtil_logAndThrow(new T.CompilerSyntaxError(C.JSString_methods.$add("Expected statement, found type ", J.get$value$x(t1.get$type(token))) + " on line " + C.JSInt_methods.toString$0(token.get$line())), $.get$Parser_log());
        token = this.popNextToken$0();
      }
    },
    expression$1: function(currNode) {
      var temp, token, t1;
      $.get$Parser_log().log$4(C.Level_INFO_800, "Parsing an expression on line " + C.JSInt_methods.toString$0(this.getToken$0().get$line()), null, null);
      currNode = this.addChild$2(C.NonTerminal_EXPRESSION, currNode);
      if (this.isNextToken$1(C.TokenType_DIGIT)) {
        $.get$Parser_log().log$4(C.Level_INFO_800, "Parsing an int expression on line " + C.JSInt_methods.toString$0(this.getToken$0().get$line()), null, null);
        ...
        this.addChild$2(J.get$value$x(this.getToken$0()), temp);
        if (this.isNextToken$1(C.TokenType_INT_OP)) {
          this.expect$1(C.TokenType_INT_OP);
          token = this.getToken$0();
          t1 = J.getInterceptor$x(token);
          temp = this.addChild$2(t1.get$type(token), currNode);
          this.addChild$2(t1.get$value(token), temp);
    ...
    booleanExpression$1: function(currNode) {
      var booleanExpr, token, t1, op, temp;
      $.get$Parser_log().log$4(C.Level_INFO_800, "Parsing a boolean expression on line " + C.JSInt_methods.toString$0(this.getToken$0().get$line()), null, null);
      booleanExpr = this.addChild$2(C.NonTerminal_BOOLEAN_EXPRESSION, currNode);
      if (J.$eq(J.get$type$x(this.peekNextToken$0()), C.TokenType_OPEN_PAREN)) {
        this.expect$1(C.TokenType_OPEN_PAREN);
        ...
        token = this.getToken$0();
        t1 = J.getInterceptor$x(token);
        op = this.addChild$2(t1.get$type(token), booleanExpr);
        this.addChild$2(t1.get$value(token), op);
        this.expression$1(booleanExpr);
        this.scopeCheck$0();
        this.expect$1(C.TokenType_CLOSE_PAREN);
        ...
        token = this.getToken$0();
        t1 = J.getInterceptor$x(token);
        temp = this.addChild$2(t1.get$type(token), booleanExpr);
        this.addChild$2(t1.get$value(token), temp);
      }
    },
    stringExpression$1: function(currNode) {
      var stringExpr, charList, t1, token, child, t2, child0;
      $.get$Parser_log().log$4(C.Level_INFO_800, "Parsing a string expression on line " + C.JSInt_methods.toString$0(this.getToken$0().get$line()), null, null);
      ...
      while (true) {
        ...
        token = this.getToken$0();
        t1 = J.getInterceptor$x(token);
        child = new B.Tree(t1.get$type(token), charList, null);
        t2 = [];
        t2.$builtinTypeInfo = [B.Tree];
        child.children = t2;
        charList.children.push(child);
        child0 = new B.Tree(t1.get$value(token), child, null);
        t1 = [];
        t1.$builtinTypeInfo = [B.Tree];
        child0.children = t1;
        child.children.push(child0);
    ...
    idExpression$1: function(currNode) {
      var token, t1;
      $.get$Parser_log().log$4(C.Level_INFO_800, "Parsing an id expression on line " + C.JSInt_methods.toString$0(this.getToken$0().get$line()), null, null);
      ...
      t1 = J.getInterceptor$x(token);
      this.addChild$2(t1.get$value(token), currNode);
      return t1.get$value(token);
    },
    ...
    expect$1: function(type) {
      ...
      if (!J.$eq(t1.get$type(next), type))
        M.ExceptionUtil_logAndThrow(new T.CompilerSyntaxError(C.JSString_methods.$add("Expected token of type " + type._Enum$_value + ", found type ", J.get$value$x(t1.get$type(next))) + " on line " + C.JSInt_methods.toString$0(next.get$line())), $.get$Parser_log());
    },
    expectOneOf$1: function(types) {
      var next, t1, t2, type;
      next = this.popNextToken$0();
      for (t1 = new H.ListIterator(types, 2, 0, null), t2 = J.getInterceptor$x(next); t1.moveNext$0();) {
        type = t1._current;
        if (J.$eq(t2.get$type(next), type))
          return;
      }
      M.ExceptionUtil_logAndThrow(new T.CompilerTypeError(C.JSString_methods.$add("Expected token of type " + H.IterableMixinWorkaround_toStringIterable(types, "[", "]") + ", found type ", J.get$value$x(t2.get$type(next))) + " on line " + C.JSInt_methods.toString$0(next.get$line())), $.get$Parser_log());
    },
    isNextToken$1: function(type) {
      if (!J.$eq(J.get$type$x(this.peekNextToken$0()), type))
        return false;
      return true;
    },
    scopeCheck$0: function() {
      var token, t1, symbol, symbols, min, min0;
      token = this.getToken$0();
      t1 = J.getInterceptor$x(token);
      if (J.$eq(t1.get$type(token), C.TokenType_ID)) {
        symbol = t1.get$value(token);
        ...
        if (symbols.length !== 0) {
          ...
          if (this.scope >= min)
            $.get$Parser_log().log$4(C.Level_INFO_800, "Identifier " + H.S(symbol) + " on line " + C.JSInt_methods.toString$0(this.getToken$0().get$line()) + (" scope OK. Current scope is " + this.scope + ", min scope is " + min + " "), null, null);
          else
            M.ExceptionUtil_logAndThrow(new T.CompilerSyntaxError("Identifier " + H.S(symbol) + " used out of scope on line " + C.JSInt_methods.toString$0(this.getToken$0().get$line())), $.get$Parser_log());
        } else
          M.ExceptionUtil_logAndThrow(new T.CompilerSyntaxError("Identifier " + H.S(symbol) + " undefined on line " + C.JSInt_methods.toString$0(this.getToken$0().get$line())), $.get$Parser_log());
      }
    },
...
["polymer", "package:polymer/polymer.dart", , A, {
  ...
  PolymerDeclaration: {
    "^": "HtmlElement;_type,_supertype,_super,_polymer$_name,_polymer$_publish,_publishLC,_observe,_instanceAttributes,_sheets,_styles,_eventDelegates,_templateDelegates",
    ...
    static: {"^": "PolymerDeclaration__TAG"}
  },
  Polymer: {
    "^": "Object;$$:polymer$Polymer$$=-23",
    $isElement: true
  },
  PolymerElement: {
    "^": "HtmlElement_Polymer_ChangeNotifier;change_notifier$ChangeNotifier$_changes,change_notifier$ChangeNotifier$_records,polymer$Polymer$_declaration,polymer$Polymer$_observers,polymer$Polymer$_unbound,polymer$Polymer$_unbindAllJob,polymer$Polymer$_propertyObserver,polymer$Polymer$syntax,polymer$Polymer$_shadowRoots,polymer$Polymer$$-23"
  },
  HtmlElement_Polymer: {
    "^": "HtmlElement+Polymer;$$:polymer$Polymer$$=-23",
    $isElement: true
  },
  HtmlElement_Polymer_ChangeNotifier: {
...
function dart_precompiled($collectedClasses) {
  ...
  Enum0.builtin$cls = "Enum0";
  if (!"name" in Enum0)
    Enum0.name = "Enum0";
  $desc = $collectedClasses.Enum0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Enum0.prototype = $desc;
  function SemanticAnalyzer(cst, symbols) {
    this.cst = cst;
    this.symbols = symbols;
  }
  SemanticAnalyzer.builtin$cls = "SemanticAnalyzer";
  if (!"name" in SemanticAnalyzer)
    SemanticAnalyzer.name = "SemanticAnalyzer";
  $desc = $collectedClasses.SemanticAnalyzer;
  if ($desc instanceof Array)
    $desc = $desc[1];
  SemanticAnalyzer.prototype = $desc;
  function CompilerSymbol(id, scope, line, type) {
    this.id = id;
    this.scope = scope;
    this.line = line;
    this.type = type;
  }
  CompilerSymbol.builtin$cls = "CompilerSymbol";
  if (!"name" in CompilerSymbol)
    CompilerSymbol.name = "CompilerSymbol";
  $desc = $collectedClasses.CompilerSymbol;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ...
  CompilerSymbol.prototype.get$scope = function() {
    return this.scope;
  };
  ...
  function NonTerminal(_Enum$_value) {
    this._Enum$_value = _Enum$_value;
  }
  NonTerminal.builtin$cls = "NonTerminal";
  if (!"name" in NonTerminal)
    NonTerminal.name = "NonTerminal";
  $desc = $collectedClasses.NonTerminal;
  if ($desc instanceof Array)
    $desc = $desc[1];
  NonTerminal.prototype = $desc;
  ...
  Token.prototype.get$line = function() {
    return this.line;
  };
  function TokenType(_Enum$_value) {
    this._Enum$_value = _Enum$_value;
  }
  TokenType.builtin$cls = "TokenType";
  if (!"name" in TokenType)
    TokenType.name = "TokenType";
  $desc = $collectedClasses.TokenType;
  if ($desc instanceof Array)
    $desc = $desc[1];
  TokenType.prototype = $desc;
  function Tree(data, parent, children) {
    this.data = data;
    this.parent = parent;
    this.children = children;
  }
  Tree.builtin$cls = "Tree";
  if (!"name" in Tree)
    Tree.name = "Tree";
  $desc = $collectedClasses.Tree;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Tree.prototype = $desc;
  Tree.prototype.get$data = function(receiver) {
    return this.data;
  };
  Tree.prototype.get$children = function(receiver) {
  ...
  function Compiler(log, source, tokens, symbols, cst, ast, parser, analyzer) {
    this.log = log;
    this.source = source;
    this.tokens = tokens;
    this.symbols = symbols;
  ...
  function CompilerSyntaxError(message) {
    this.message = message;
  }
  CompilerSyntaxError.builtin$cls = "CompilerSyntaxError";
  if (!"name" in CompilerSyntaxError)
    CompilerSyntaxError.name = "CompilerSyntaxError";
  $desc = $collectedClasses.CompilerSyntaxError;
  if ($desc instanceof Array)
    $desc = $desc[1];
  CompilerSyntaxError.prototype = $desc;
  function CompilerTypeError(message) {
    this.message = message;
  }
  CompilerTypeError.builtin$cls = "CompilerTypeError";
  if (!"name" in CompilerTypeError)
    CompilerTypeError.name = "CompilerTypeError";
  $desc = $collectedClasses.CompilerTypeError;
  if ($desc instanceof Array)
    $desc = $desc[1];
  CompilerTypeError.prototype = $desc;
  ...
  function Parser(tokens, cst, symbols, index, scope) {
    this.tokens = tokens;
    this.cst = cst;
    this.symbols = symbols;
    this.index = index;
  ...
  Parser.prototype.get$scope = function() {
    return this.scope;
  };
  function PolymerDeclaration(_type, _supertype, _super, _polymer$_name, _polymer$_publish, _publishLC, _observe, _instanceAttributes, _sheets, _styles, _eventDelegates, _templateDelegates) {
    this._type = _type;
