          ...
          if (t7.$eq(lexeme, "$")) {
            ...
            if (t2.test(lexeme)) {
              ...
              for (t6 = new J._CodeUnits(t7.replaceAll$2(lexeme, "\"", "")), t6 = t6.get$iterator(t6); t6.moveNext$0();) {
                charCodes = P.List_List$filled(1, t6._dev$_current, J.JSInt);
...
["_interceptors", "dart:_interceptors", , J, {
  ...
  Interceptor: {
    ...
    "%": "MediaError|MediaKeyError|Navigator|PositionError|SQLError|SVGAnimatedEnumeration|SVGAnimatedNumberList"
  },
  JSBool: {
    "": "bool/Interceptor;",
    toString$0: function(receiver) {
...
["", "compiler/compiler.dart", , X, {
  "": "",
  Compiler: {
    "": "Object;log,source,tokens,parser",
    run$0: function() {
      var t1, token, t2, exception;
      try {
        t1 = L.Lexer_analyze(this.source);
        this.tokens = t1;
        t1 = new G.Parser(t1, H.setRuntimeTypeInfo([], [T.CompilerSymbol]), 0, 0);
        this.parser = t1;
        ...
        if (t1.tokens.length !== 0) {
          ...
          t1.statementList$0();
          t1.scope = t1.scope - 1;
          token = t1.popNextToken$0();
          t1 = token.type;
          t2 = J.getInterceptor(t1);
          if (!t2.$eq(t1, C.TokenType_END))
            M.ExceptionUtil_logAndThrow(new T.CompilerSyntaxError(C.JSString_methods.$add("Expected END token, found type ", t2.get$value(t1)) + " on line " + C.JSInt_methods.toString$0(token.line)), $.get$Parser_log());
...
["", "main.dart", , F, {
  ...
  main: [function() {
    ...
    t3 = H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(t1, t2, false), [null]);
  ...
  compile: [function($event) {
    ...
    new X.Compiler(K.LoggerUtil_createLogger("Compiler"), source, H.setRuntimeTypeInfo([], [D.Token]), null).run$0();
...
["", "compiler/parser.dart", , G, {
  ...
  Parser: {
    ...
    statementList$0: function() {
      var token, t1, t2, t3, token0, t4, t5;
      ...
      for (t1 = this.symbols; t2 = token.type, t3 = J.getInterceptor(t2), !t3.$eq(t2, C.TokenType_CLOSE_BRACE);) {
        if (t3.$eq(t2, C.TokenType_TYPE)) {
          ...
          M.ExceptionUtil_logAndThrow(new T.CompilerSyntaxError(C.JSString_methods.$add("Expected statement, found type ", t3.get$value(t2)) + " on line " + C.JSInt_methods.toString$0(token.line)), $.get$Parser_log());
        token = this.popNextToken$0();
      }
    },
    ...
    stringExpression$0: function() {
      this.expect$1(C.TokenType_QUOTE);
      while (true) {
        if (this.peekNextToken$0() != null)
          var t1 = this.isNextToken$1(C.TokenType_CHAR) || this.isNextToken$1(C.TokenType_SPACE);
        else
          t1 = false;
        if (!t1)
          break;
    ...
    expect$1: function(type) {
      ...
      t2 = J.getInterceptor(t1);
      if (!t2.$eq(t1, type))
        M.ExceptionUtil_logAndThrow(new T.CompilerSyntaxError(C.JSString_methods.$add("Expected token of type " + type._Enum$_value + ", found type ", t2.get$value(t1)) + " on line " + C.JSInt_methods.toString$0(next.line)), $.get$Parser_log());
    },
    expectOneOf$1: function(types) {
      var next, t1, type;
      next = this.popNextToken$0();
      for (t1 = new H.ListIterator(types, 2, 0, null); t1.moveNext$0();) {
        type = t1._dev$_current;
        if (J.$eq(next.type, type))
          return;
      }
      M.ExceptionUtil_logAndThrow(new T.CompilerTypeError(C.JSString_methods.$add("Expected token of type " + H.IterableMixinWorkaround_toStringIterable(types, "[", "]") + ", found type ", J.get$value$x(next.type)) + " on line " + C.JSInt_methods.toString$0(next.line)), $.get$Parser_log());
    },
...
function dart_precompiled($collectedClasses) {
  ...
  function Compiler(log, source, tokens, parser) {
    this.log = log;
    this.source = source;
    this.tokens = tokens;
    this.parser = parser;
  ...
  function HashMapKeyIterator(_map, _keys, _offset, _current) {
    this._map = _map;
    this._keys = _keys;
  ...
  function HashSetIterator(_set, _elements, _offset, _current) {
    this._set = _set;
    this._elements = _elements;
    this._offset = _offset;
    this._current = _current;
  ...
  function _ListQueueIterator(_queue, _end, _modificationCount, _position, _current) {
    this._queue = _queue;
    this._end = _end;
    this._modificationCount = _modificationCount;
  ...
  function Parser(tokens, symbols, index, scope) {
    this.tokens = tokens;
